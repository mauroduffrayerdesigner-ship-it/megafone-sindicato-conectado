-- Insert the 6 static blog posts into the database
INSERT INTO public.blog_posts (slug, title, excerpt, content, category, image_url, read_time, published, created_at)
VALUES 
(
  'importancia-comunicacao-sindical',
  'A Importância da Comunicação Sindical na Era Digital',
  'Descubra como a comunicação digital pode fortalecer a relação entre sindicatos e trabalhadores, aumentando o engajamento e a mobilização.',
...
(
  'whatsapp-ferramenta-mobilizacao',
  'WhatsApp como Ferramenta de Mobilização Sindical',
  'Aprenda estratégias eficazes para usar o WhatsApp na comunicação com a base trabalhadora e aumentar a participação em ações sindicais.',
...
<p>O WhatsApp Business oferece recursos adicionais como catálogo, respostas automáticas e etiquetas para organizar conversas. Considere usar essa versão para a comunicação oficial do sindicato.</p>',
  'WhatsApp',
  'https://images.unsplash.com/photo-1611606063065-ee7946f0787a?w=800&auto=format&fit=crop',
  '7 min',
  true,
  '2024-01-10'::timestamp with time zone
),
(
  'redes-sociais-sindicatos',
  'Redes Sociais para Sindicatos: Guia Completo',
  'Um guia prático para sindicatos que desejam melhorar sua presença nas redes sociais e alcançar mais trabalhadores.',
...
(
  'design-grafico-campanhas',
  'Design Gráfico Eficaz para Campanhas Sindicais',
  'Dicas de design para criar materiais visuais impactantes que comunicam a mensagem do sindicato de forma clara e atrativa.',
...
(
  'video-marketing-sindical',
  'Vídeo Marketing para Sindicatos: Por Onde Começar',
  'Entenda como o vídeo pode ser uma ferramenta poderosa na comunicação sindical e aprenda a criar conteúdos que engajam.',
...
(
  'metricas-comunicacao',
  'Métricas Essenciais para Avaliar sua Comunicação',
  'Aprenda a medir o sucesso de suas estratégias de comunicação e tomar decisões baseadas em dados.',
...
<p>Cada plataforma oferece suas próprias ferramentas de análise. Aprenda a usar o Facebook Insights, Instagram Insights e YouTube Analytics para acompanhar seu desempenho.</p>',
  ...
  '6 min',
  true,
  '2023-12-20'::timestamp with time zone
);