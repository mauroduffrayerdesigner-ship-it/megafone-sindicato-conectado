      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-primary-foreground/80 mb-10 leading-relaxed">
            Entre em contato e descubra como podemos fortalecer a comunicação com sua categoria.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="xl" className="bg-white text-primary hover:bg-white/90 font-bold" asChild>
              <Link to="/contato">
                Solicitar Proposta
                <ArrowRight size={20} />
              </Link>
            </Button>
            <Button variant="outline" size="xl" className="border-2 border-white text-white hover:bg-white/10 bg-transparent" asChild>
